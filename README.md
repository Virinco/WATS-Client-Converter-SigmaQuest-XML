# WATS Converter - SigmaQuest XML format

A WATS Client converter plugin for importing test data from SigmaQuest test system to WATS.
...
This is an example converter for SigmaQuest that only supports output in the same format as the example files. Different configurations of the test software will require an accordingly different converter.
